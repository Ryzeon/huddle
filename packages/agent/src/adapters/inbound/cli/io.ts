...
export function usage(): never {
  console.error(
    [
      ...
      '    --policy <modo>      open (por defecto) | approved (tú apruebas a cada uno)',
      '    --folder <quién>     all (por defecto) | host (solo tú escribes en la carpeta)',
      '    --sin-memoria        No dejar las respuestas escritas en la carpeta',
      '',
      ...
      '',
      '  folder ls              La carpeta compartida de la sala',
      '  folder cat <ruta>      Ver un archivo de la carpeta',
      '  folder put <ruta> [..] Escribir en ella (o por la entrada estándar)',
      '  folder rm <ruta>       Borrarlo, para todos',
      '',
      ...
      '  pending                Quién espera a entrar (salas con aprobación)',
      '  admit <id>             Dejar entrar a quien espera',
      '    --once               Solo esta vez; la próxima vuelve a pedir permiso',
      '  deny <id>              No dejarle entrar',
